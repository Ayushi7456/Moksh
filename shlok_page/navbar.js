  ...
  let footerContent = `
    <!-- NewsLetter  -->
          ...
          <div class="mt-8 siteNav flex flex-col lg:flex-row ">
            ...
            <div class="flex flex-col lg:flex-row items-center text-center lg:text-centre lg:w-1/2">
          ...
          <div class="mt-8 copyRight flex items-center justify-center text-xs text-slate-300 flex-col">
            <p class='text-center' style = "color:white;" >Made with ❤️ by Ayushi Gupta</p>
